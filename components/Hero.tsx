...
export default function Hero() {
  ...
  return (
    ...
    <section
      id='home'
      className='relative min-h-screen overflow-hidden flex items-center px-6 pt-24'
    >
      ...
      <div className='absolute bottom-10 right-10 w-96 h-96 bg-[#d6c8a4]/20 rounded-full blur-3xl animate-pulse'></div>
      ...
      <div className='max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-20 items-center relative z-10'>
        ...
        >
          ...
          >
            ...
            <p className='uppercase tracking-[0.3em] text-[#d6c8a4] text-xs'>
          ...
          <motion.p
            ...
            className='mt-8 text-xl text-gray-300 leading-relaxed max-w-2xl'
          >
          ...
          <div className='flex flex-wrap gap-4 mt-10'>
            ...
            {[
              ...
              <motion.div
                ...
                className='px-5 py-3 rounded-full bg-white/5 border border-white/10 backdrop-blur-xl hover:border-[#d6c8a4] transition duration-300 cursor-default'
              >
        ...
        >
          ...
          <motion.div
            ...
            className='absolute w-[480px] h-[480px] rounded-full border border-[#d6c8a4]/20'
          ></motion.div>

          {/* Glow */}
          <div className='absolute w-[400px] h-[400px] bg-[#d6c8a4]/20 blur-3xl rounded-full'></div>
          ...
          >
            ...
            <motion.img
              ...
              className='relative z-10 w-[420px] object-cover drop-shadow-[0_0_80px_rgba(214,200,164,0.35)]'
            />
